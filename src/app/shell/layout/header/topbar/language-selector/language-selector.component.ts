...
// Services
import { TranslationService } from '@app/shared';
...
export class LanguageSelectorComponent implements OnInit {
  ...
  @HostBinding('class') classes =
    ...
    'm-nav__item m-topbar__languages m-dropdown m-dropdown--small m-dropdown--arrow m-dropdown--align-right m-dropdown--mobile-full-width';
  ...
  setSelectedLanguage(): any {
    this.translationService.getSelectedLanguage().subscribe((lang: any) => {
      if (lang) {
        setTimeout(() => {
