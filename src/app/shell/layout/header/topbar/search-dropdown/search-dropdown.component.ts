...
// Directives
import { QuickSearchDirective } from '@app/shared';
import { LayoutConfigService } from '@app/shared';

// Services
import { QuickSearchService } from '@app/shared';
...
export class SearchDropdownComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    Promise.resolve(null).then(() => {
      ...
      this.onSearch = this.mQuickSearchDirective.onSearch$.subscribe((mQuickSearch: any) => {
