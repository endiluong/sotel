...
// Services
import { ClassInitService, MenuAsideService, LayoutConfigService, LayoutRefService } from '@app/shared';
  ...
  mouseLeave(e: Event) {
    if (this.document.body.classList.contains('m-aside-left--fixed')) {
      ...
      this.outsideTm = setTimeout(() => {
        ...
        if (
          this.document.body.classList.contains('m-aside-left--minimize-hover') &&
