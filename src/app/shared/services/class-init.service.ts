...
export class ClassInitService {
  ...
  initHeaderMenuDesktop(): void {
    ...
    this.classes.header_menu.push(
      'm-header-menu--submenu-skin-' + objectPath.get(this.config, 'menu.header.desktop.submenu.skin')
    );
  ...
  initAsideMenu(): void {
    ...
    if (objectPath.get(this.config, 'menu.aside.desktop_and_mobile.submenu.skin') === 'inherit') {
      ...
      this.classes.aside_menu.push(
        'm-aside-menu--submenu-skin-' + objectPath.get(this.config, 'menu.aside.desktop_and_mobile.submenu.skin')
      );
    }

    if (
      !objectPath.get(this.config, 'aside.left.fixed') &&
      !objectPath.get(this.config, 'menu.aside.desktop_and_mobile.submenu.accordion')
    ) {
